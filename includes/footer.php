...
(function(){
	...
	s1.async=true;
	s1.src='https://embed.tawk.to/5767dcdc4d15053715bbe63a/default';
	s1.charset='UTF-8';
...
if(strpos($_SERVER['HTTP_HOST'], 'wakeuppension.com') === true){
	...
	echo '<script type="text/javascript">//' . strpos($_SERVER['HTTP_HOST'], 'wakeuppension.com') . ';</script>';
}
	?>
