				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<!--logo section-->
							<div class="logo_blk">
								<a class="col-sm-11" href="#">
									<img class="cs_nav_bar_logo" src="images/wakeup_logo.png" alt="Logo">
								</a>
							</div>
							<!--logo section-->
							...
							<nav class="navbar navbar-default">
								<div class="container-fluid">
									<div class="navbar-header">
										<button type="button" class="navbar-toggle cs_subpage_navbar-toggle collapsed" data-toggle="collapse"
												data-target="#bs-example-navbar-collapse-1" aria-expanded="false"><span
																														class="icon-bar"></span> <span class="icon-bar"></span> <span
                                        class="icon-bar"></span></button>
									</div>
									<div class="collapse navbar-collapse cs_subpage_navbar-collapse" id="bs-example-navbar-collapse-1">
							...
							<!--	navigation section-->
							<div class="clienthd-area">
								<a href="#">
									<i class="wake-icon26"></i>
									<span>אזור אישי</span>
								</a>
							</div>
							<!-- hidding orange button -->
							<!--
<div class="cs_subpage_call-action call-action">
						...
						<div class="col-sm-12">
							<div class="top-cont-blk">
								...
								<span id="guide-template"><i
															 class="fa fa-check"></i>הצבירה שלך לגיל הפרישה יכולה לגדול  ב <strong>453,302 ₪</strong> אם תבחר ליישם את המלצותינו.</span>
...
================================================== -->
		...
		<script src="js/csjavascript/cs_subpagescript.js"></script>
